...
function CommentEditModal({
  ...
  const onClickModify = Object(external_react_["useCallback"])(() => {
    if (confirm('댓글을 수정하시겠습니까?')) {
      dispatch(Object(actionPost["h" /* updateCommentRequestAction */])({
        postId,
        commentId,
        content
      }));
...
/* harmony default export */ var Modals_CommentEditModal = __webpack_exports__["default"] = (/*#__PURE__*/Object(external_react_["memo"])(CommentEditModal));
