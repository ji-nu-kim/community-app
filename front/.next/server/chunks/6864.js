...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ Modals_PostEditModal; }
});
...
function PostEditModal({
  ...
  const [content, onChangeContent] = (0,useInput/* default */.Z)(currentPostText || '');
  const onClosePostEditModal = (0,external_react_.useCallback)(() => {
    setCurrentModifyPost(0);
    setEditMode(false);
  }, []);
  const onClickModify = (0,external_react_.useCallback)(() => {
    if (confirm('게시글을 수정하시겠습니까?')) {
      dispatch((0,actionPost/* updatePostRequestAction */.VR)({
        content,
        postId,
        communityId
      }));
...
/* harmony default export */ var Modals_PostEditModal = (/*#__PURE__*/(0,external_react_.memo)(PostEditModal));
