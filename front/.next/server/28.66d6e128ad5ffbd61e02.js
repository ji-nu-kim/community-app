...
const ShowCommunityUserModal = dynamic_default()(() => __webpack_require__.e(/* import() */ 41).then(__webpack_require__.bind(null, "GHRU")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("GHRU")],
    modules: ['components/Modals/ShowCommunityUserModal']
  }
});
