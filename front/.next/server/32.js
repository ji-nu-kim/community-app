...
const PostSettingModal = dynamic_default()(() => __webpack_require__.e(/* import() */ 38).then(__webpack_require__.bind(null, "75CV")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("75CV")],
    modules: ["..\\components\\CommunityBody\\Post\\index.tsx -> " + 'components/Modals/PostSettingModal']
  }
});
const PostEditModal = dynamic_default()(() => __webpack_require__.e(/* import() */ 23).then(__webpack_require__.bind(null, "XmWp")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("XmWp")],
    modules: ["..\\components\\CommunityBody\\Post\\index.tsx -> " + 'components/Modals/PostEditModal']
  }
});
const CommentSettingModal = dynamic_default()(() => __webpack_require__.e(/* import() */ 36).then(__webpack_require__.bind(null, "/i6i")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("/i6i")],
    modules: ["..\\components\\CommunityBody\\Post\\index.tsx -> " + 'components/Modals/CommentSettingModal']
  }
});
const CommentEditModal = dynamic_default()(() => __webpack_require__.e(/* import() */ 21).then(__webpack_require__.bind(null, "g1Iv")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("g1Iv")],
    modules: ["..\\components\\CommunityBody\\Post\\index.tsx -> " + 'components/Modals/CommentEditModal']
  }
});
const PostForm = dynamic_default()(() => __webpack_require__.e(/* import() */ 28).then(__webpack_require__.bind(null, "MNTT")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("MNTT")],
    modules: ["..\\components\\CommunityBody\\Post\\index.tsx -> " + 'components/PostForm']
  }
});
const CommentForm = dynamic_default()(() => __webpack_require__.e(/* import() */ 25).then(__webpack_require__.bind(null, "gwkI")), {
  loadableGenerated: {
